...
def main(argv):
    ...
    prefix_tokenizer = OpenLLMConfig.get_tokenizer(
        FLAGS.tokenizer, truncation_side='left', padding_side='left'
    )
    tokenizer = OpenLLMConfig.get_tokenizer(
    ...
    with jax.default_device(jax.devices("cpu")[0]):
        ...
        hf_model = FlaxOpenLLMForCausalLM(
            model_config,
    ...
    model_ps = match_partition_rules(
        OpenLLMConfig.get_partition_rules(), params
    )
    ...
    def forward_loglikelihood(params, rng, batch):
        ...
        logits = hf_model.module.apply(
            ...
            deterministic=True, rngs=rng_generator(model_config.rng_keys()),
        ).logits
