...
from models.phi2.model import Phi2Config, FlaxPhi2ForCausalLM
...
def main(argv):
    ...
    prefix_tokenizer = Phi2Config.get_tokenizer(
        FLAGS.tokenizer, truncation_side='left', padding_side='left'
    )
    tokenizer = Phi2Config.get_tokenizer(
    ...
    model_ps = match_partition_rules(
        Phi2Config.get_partition_rules(), params
    )
